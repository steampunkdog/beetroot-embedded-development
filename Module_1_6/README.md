...
### Результат
В середньому похибка скласа `5.08%`. Оскільки було обрано резистор з опором `1кОм` для отримання середнього значення напруги при денному освітленні, похибка є більшою(`~7.5%`) для вимірів низької освітленості  
...
Зниження аттенюації критично впливає на точність вимірювання. Похибка зросла до 77.7% що є неприпустимо неточним. \
Напруга зрирахувани з даних отриманих з АЦП майже вдвічі перевищує реальні показники.
